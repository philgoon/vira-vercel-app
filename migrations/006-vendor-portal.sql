-- Migration 006: Vendor Portal - Invites & Applications
...
-- Anyone can view their own invite (by token, handled in application)
...
-- Anyone can create applications (via invite link)
...
-- Admins can manage vendor users
...
-- Vendors can view their own user mapping
