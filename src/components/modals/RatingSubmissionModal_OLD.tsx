...
import {
  ...
  HelpCircle, // [M4] Training tooltips
  Lightbulb // [M4] Helpful hints
} from 'lucide-react'
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="mt-6 grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div>
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <div className="group relative">
                  ...
                  <div className="absolute left-0 top-6 w-72 p-3 bg-gray-900 text-white text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10 shadow-lg">
                    <p className="font-semibold mb-1">💡 Be specific! Examples:</p>
                    <ul className="list-disc list-inside space-y-1">
                      <li>"Delivered 2 days early with all features"</li>
                      <li>"Proactive communication about issues"</li>
                      <li>"High-quality work, minimal revisions"</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            />
            {ratings.positive_feedback.length === 0 && (
              <div className="mt-2 flex items-start gap-2 text-xs text-blue-600">
                <Lightbulb className="w-4 h-4 flex-shrink-0 mt-0.5" />
                <span><strong>Tip:</strong> Mention deliverables, timeline, and quality</span>
              </div>
            )}
          </div>
          <div>
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <div className="group relative">
                  <HelpCircle className="w-4 h-4 text-gray-400 cursor-help" />
                  <div className="absolute left-0 top-6 w-72 p-3 bg-gray-900 text-white text-xs rounded-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-10 shadow-lg">
                    <p className="font-semibold mb-1">💡 Be constructive! Examples:</p>
                    <ul className="list-disc list-inside space-y-1">
                      <li>"Response time could be faster (24h+ delays)"</li>
                      <li>"More frequent progress updates needed"</li>
                      <li>"Testing could be more thorough"</li>
                    </ul>
                  </div>
                </div>
              </div>
            ...
            />
            {ratings.improvement_feedback.length === 0 && (
              <div className="mt-2 flex items-start gap-2 text-xs text-orange-600">
                <Lightbulb className="w-4 h-4 flex-shrink-0 mt-0.5" />
                <span><strong>Tip:</strong> Be specific and actionable</span>
              </div>
            )}
          </div>
        </div>
